...
def graficar(x, y):
    grafica = figure(title='Camino aleatorio', x_axis_label='paso', y_axis_label='distacia recoridaa'  )
    grafica.line(x, y, legend= 'distacia media')
...
def main(distancias_de_caminata, numero_de_intentos, tipo_de_borracho):
    ...
    for pasos in  distancias_de_caminata:
        ...
        print(f'{tipo_de_borracho.__name__} caminata aleatoria de {pasos} pasoos')
        print(f' Media = {distancia_media} ')
        print(f' Max = {distancia_maxima} ')
        print(f' MIN = {distancias_minima} ')
